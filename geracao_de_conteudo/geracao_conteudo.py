...
def encontrar_modelo(cacteristica_fornecida):
  for caracteristica, modelo in caracteristicas_modelos.items():
    if caracteristica.lower() in cacteristica_fornecida.lower():
      return modelo
  return "Modelo não encontrado."

caracterista_fornecida = input()

modelo_correspondente = encontrar_modelo(caracterista_fornecida)
